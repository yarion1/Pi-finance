...
| 11 | Upload sem validação | Arquivos em base64 com teto de 8 MB, lidos só como OFX/CSV/XLSX; o `.xlsx` abre com limite de descompactação (contra zip bomb); nada é salvo em disco nem servido de volta. | `decodificarArquivo`, `importadores` |
